		...
		<article class="bc-content-component__content">
			...
			<h1 class="bc-content-component__heading">ISD Admissions Overview</h1>
				...
				<div class="bc-stepped-process">
					<h3 class="bc-stepped-process__heading is-orange-text">1. Express an interest</h3>
					...
					<h3 class="bc-stepped-process__heading is-red-text">2. Submit a pre-enrolment form</h3>
					...
					<h3 class="bc-stepped-process__heading is-primary-text">3. The School Tour</h3>
					...
					<h3 class="bc-stepped-process__heading is-mid-green-text">4. Offer of a place</h3>
					...
					<h3 class="bc-stepped-process__heading is-indigo-text">5. Acceptance</h3>
