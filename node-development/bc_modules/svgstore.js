(function bcSvgStore() {
	...
	*/
	...
	if (debug) {
		console.log(`${messagePrefix} options:`);
		console.log(options);
	}
	...
	if (debug) {
		console.log(`${messagePrefix} svgsSource:`);
		console.log(`${messagePrefix} ${svgsSource}`);
		console.log(`${messagePrefix} srcSVGs:`);
		console.log(`${messagePrefix} ${srcSvgs}`);
	}
	try {	
		let sprite = svgstore(options);
		if (debug) {
			console.log(`${messagePrefix} sprite:`);
			console.log(`${messagePrefix} ${sprite}`);
		}
		if (srcSvgs.length) {
			for (svg in srcSvgs) {	
			...
			fs.open(outputDir, 'w+', (err, outputFD) => {
				if (debug) {
					console.log(`${messagePrefix} outputFD:`);
					console.log(`${outputFD}`);	
				}
				if (err) {
